          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className={`p-8 space-y-6 transition-all duration-300 hover:shadow-lg dark:hover:shadow-xl bg-white/90 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 ${currentTier === "basic" ? "ring-2 ring-primary moon-glow" : ""} animate-fade-in-up`} style={{ animationDelay: '200ms' }} data-testid="card-plan-basic">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-sm text-slate-900 dark:text-slate-100">Up to 6 seconds</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
            ...
            <Card className={`p-8 space-y-6 relative ring-2 ring-primary transition-all duration-300 hover:shadow-xl dark:hover:shadow-2xl md:scale-105 bg-white/95 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 ${currentTier === "pro" ? "moon-glow" : ""} animate-fade-in-up`} style={{ animationDelay: '300ms' }} data-testid="card-plan-pro">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-sm text-slate-900 dark:text-slate-100">Up to 8 seconds</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
